// Clarity — bilinear upsample pass.
//
// Upsamples the input to output dimensions using manual bilinear interpolation
// from the 4 nearest input texels. The scale factor is derived from texture
// dimensions so no hardcoded constant is needed.
//
// Declares the full ClarityParams struct to satisfy WebGPU's uniform
