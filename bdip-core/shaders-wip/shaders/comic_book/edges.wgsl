// Comic Book — edge detection pass (Sobel on Source).
//
// Produces bold black outlines typical of comic book inking. Uses a lower
// edge_threshold and higher edge_darkness than the Cartoon shader's edge pass
// to achieve thicker, more pronounced lines.
//
// Output: single-channel edge mask stored in .r; .gba = (0, 0, 1).
//
// All Comic Book WGSL files declare the full ComicBookParams struct to satisfy
