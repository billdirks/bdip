// Cartoon — horizontal separable Gaussian blur pass.
//
...
// Sigma is 1.5% of the longer image dimension. Smaller than Clarity's 2% because
// the smoothed image is the final color base — overshooting the radius erases
// structure the user wanted to keep.
