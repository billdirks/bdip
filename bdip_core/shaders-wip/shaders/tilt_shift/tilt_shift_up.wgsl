// Tilt-Shift — bilinear upsample pass.
//
// Upsamples the blurred 4× downsampled texture back to full resolution using
// manual bilinear interpolation from the 4 nearest input texels. The scale
// factor is derived from texture dimensions at dispatch time.
//
